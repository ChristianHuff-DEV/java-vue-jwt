...
/**
 * Implementation to deal with the secure storage of passwords.<br>
 * <p>
 * Taken from https://github.com/defuse/password-hashing
 *
 * @author christian
 */
public class PasswordService implements Service {
    ...
    /**
     * Create the hash representation for the given password.
     *
     * @param password - clear text password to hash
     * @return - hash representing the password
    ...
    protected String createHash(char[] password) throws CannotPerformOperationException {
     ...
     * @param correctHash - hash to compare the password to
     * @return
     * @throws CannotPerformOperationException
    ...
    protected boolean verifyPassword(char[] password, String correctHash)
            throws CannotPerformOperationException, InvalidHashException {
